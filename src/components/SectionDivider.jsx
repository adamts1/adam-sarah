...
export default function SectionDivider({ minimalOnMobile }) {
  const lineClass = minimalOnMobile ? 'hidden md:block flex-1 max-w-[120px] md:max-w-[180px] h-px bg-coral-dark/20' : 'flex-1 max-w-[120px] md:max-w-[180px] h-px bg-coral-dark/20'
  return (
